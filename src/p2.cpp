...
#pragma region GAME_VARIABLES
		...
		PATTERN_OFFSET_DWORD_PTR_CAST_TYPE(ENGINE_MOD, g_frustum, Frustum_t*, "B9 ? ? ? ? E8 ? ? ? ? 84 C0 75 ? ? ? ? 57", 1, USE_OFFSET(0xE6CD8, 0xE6378)); // ENGINE_BASE + USE_OFFSET(0x615390, 0x60FC20)
