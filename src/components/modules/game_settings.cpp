...
namespace components
{
	...
	bool game_settings::parse_toml()
	{
		...
		if (std::filesystem::exists("portal2-rtx\\game_settings.toml"))
		{
			try
			{
...
#define ASSIGN(name)																															\
					...
					{																																			\
						...
						{																																		\
							...
							} else { common::log("GameSettings", std::format("Not using saved value for {} because default setting was updated in a recent update.", vars.##name.m_name), common::LOG_TYPE::LOG_TYPE_WARN); } \
						} \
					}
